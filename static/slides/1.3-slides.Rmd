...
See appendix in [today's class page](content/1.3-content) for more.
]
...
- MRS is the .hi[slope of the indifference curve]
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  geom_segment(aes(x=1, xend=1, y=IC_mrs(1), yend=IC_mrs(2)), linetype="solid", color="red", size=1)+
  geom_segment(aes(x=1, xend=2, y=IC_mrs(2), yend=IC_mrs(2)), linetype="solid", color="red", size=1)+
  geom_segment(aes(x=4, xend=4, y=IC_mrs(4), yend=IC_mrs(5)), linetype="solid", color="red", size=1)+
  geom_segment(aes(x=4, xend=5, y=IC_mrs(5), yend=IC_mrs(5)), linetype="solid", color="red", size=1)+
  geom_segment(aes(x=8, xend=8, y=IC_mrs(8), yend=IC_mrs(9)), linetype="solid", color="red", size=1)+
  geom_segment(aes(x=8, xend=9, y=IC_mrs(9), yend=IC_mrs(9)), linetype="solid", color="red", size=1)+
...
- .hi-purple[Principle of Revealed Preference]: if $x$ and $y$ are both affordable, and if $x$ is chosen over $y$, then the person must prefer $x \succeq y$
...
- We can't directly measure $MU$'s, but we *can* measure $MRS_{x,y}$ and infer the **ratio** of $MU$'s!
