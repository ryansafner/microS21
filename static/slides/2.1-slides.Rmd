...
- At this point:
$$\underbrace{\color{blue}{MRTS}}_{\text{PPF slope}}=\underbrace{\color{green}{MRS}}_{\text{I.C. slope}}=\underbrace{\color{purple}{\frac{p_b}{p_c}}}_{\text{price line}}$$
...
geom_point(data = export_b,
  ...
  labs(x = "Bananas",
       y = "Coconuts")+
  theme_classic(base_family = "Fira Sans Condensed", base_size=20)
home_exp+annotate("segment", x = 2, xend = 3.15, y = 2.75, yend = 1.8, colour = "purple", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="last", type="closed"))
```
]
...
5. .hi[Competitive firms produce where MC = MB]
  - Point B:
