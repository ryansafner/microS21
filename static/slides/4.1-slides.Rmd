...
.pull-left[
.smallest[
- For competitive markets, modeled firms as .hi[“price-takers”]: so many of them selling identical products
...
- In long-run, .hi[free entry and exit] caused prices to equal (average & marginal) costs and pushed economic profits to zero
]
]
...
graph+
  geom_rect(xmin=0, xmax=2, ymin=0, ymax=16, fill="blue", alpha =0.5)+
...
graph+
  geom_rect(xmin=0, xmax=2, ymin=0, ymax=14, fill="blue", alpha =0.5)+
...
- .hi-turquoise[Monopolists *only* produce where demand is elastic, with positive MR(q)!]
  - See appendix in [today’s class page](/content/4.1-content) for a proof
...
.footnote[See [today's class notes](/content/4.1-content) for the derivation.]
