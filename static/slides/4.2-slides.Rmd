...
$$C(q)=cq$$
  - No fixed costs, constant VC(q) of $cq$, $MC$ of $c$
...
- A **monopolist** faces the *entire* market demand and sets $(q_m,p_m)$:
  ...
  - Raises price to .blue[max. WTP (Demand)]: $p_m$
...
.center[
.smallest[
.hi-purple[The more (less) elastic a good, the less (more) market power]: $L=\frac{p-MC(q)}{p}=-\frac{1}{\epsilon}$
]
]
.pull-left[
...
.center[
![:scale 65%](https://www.dropbox.com/s/15ql3kjvc0cbib2/occupationallicensing2.png?raw=1)
...
.center[
![](../images/science_vs_easy_answers.jpg)
]
