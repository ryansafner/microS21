...
.pull-left[
- Perhaps the Most Fundamental Economic Principle is the .hi[law of demand]: there is an inverse relationship between price and quantity consumed
...
- Often called “Consumer Theory” in textbooks, but heed:
...
- Fair enough, consumers making purchasing decisions will be our paradigmatic *example*
...
- Only .hi-turqouise["real"] changes in *relative* prices (from changes in market conditions) change consumer constraints (and alter behavior)

- i.e. it's not about “the price of $x$,” its about “the price of x *relative to the price of y*”!
