...
coursecode: "ECON 306 Spring 2021"
section: ""
author: Dr. Ryan Safner
semester: "[springS21.classes.ryansafner.com](http://springS21.classes.ryansafner.com)"

email: "safner@hood.edu"
web: "ryansafner.com"
officehours: "<i class='fas fa-video'></i> TuTh 3:15—5 PM on Zoom"
office: "Rosenstock 118"
classroom: "<i class='fas fa-video'></i> ON ZOOM"
classhours: "MW (S.1), TuTh (S.2): 2:00--3:15PM"
...
> "The curious task of economics is to demonstrate to men how little they really know about what they imagine they can design."^[Hayek, F.A., 1988, *The Fatal Conceit*, p.76] — F.A. Hayek, 1974 Economics Nobel Laureate
...
See my [tips for success in this course](http://springS21.classes.ryansafner.com/reference#tips). 
...
You can find all course materials at my **dedicated website** for this course: [springS21.classes.ryansafner.com](https://springS21.classes.ryansafner.com). Links to the website are posted on our Blackboard course page. Please familiarize yourself with the website, see that it contains this [syllabus](https://springS21.classes.ryansafner.com/syllabus/), guides for your [reference](https://springS21.classes.ryansafner.com/reference/), and our [schedule](https://springS21.classes.ryansafner.com/schedule/). On the schedule page, you can find each module with its own class page (**start there!**) along with all related readings, lecture slides, practice problems, and assignments.
...
Your final course grade is the weighted average of the following assignments. You can find general descriptions for all the assignments on the [assignments page](http://springS21.classes.ryansafner.com/assignments/) and more specific information and examples on each assignment's page on the [schedule page](http://springS21.classes.ryansafner.com/schedule/). 
...
**You can find a full schedule** with much more details, including the readings, appendices, and other further resources for each class meeting on the [course website's schedule page](http://springS21.classes.ryansafner.com/schedule/).